const products = [
  ...
  { id: 5, name: 'Baget with cream cheese', price: 30.75, image: 'https://images.unsplash.com/photo-1599021419847-d8a7a6aba5b4?w=700&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NTh8fFNhbGFkfGVufDB8fDB8fHww' },
  { id: 6, name: 'Sausage and Egg Sandwich', price: 27.80, image: 'https://plus.unsplash.com/premium_photo-1673590981810-894dadc93a6d?w=700&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8ODF8fFNhbGFkfGVufDB8fDB8fHww'}
];
